...
/**
 * A dynamic chart creator for the predicted data.
 */
public class DynamicLineAndTimeSeriesChart extends ApplicationFrame implements ActionListener {
	...
	public DynamicLineAndTimeSeriesChart(final String title) {
		...
		super(title);
		this.series = new TimeSeries("Prediction Data", Millisecond.class);
	...
	private JFreeChart createChart(final XYDataset dataset) {
		final JFreeChart result = ChartFactory.createTimeSeriesChart("Dynamic Line And TimeSeries Chart", "Time",
